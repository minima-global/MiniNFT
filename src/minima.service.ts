import { Minima, NetworkStatus, Address, Coin } from 'minima'
...
function listBids(bidderScriptAddress: string) {
    listAllBids(bidderScriptAddress).then((bids) => {
        console.log('Global list of all bids', bids)
    }, console.error)
}

function listAuctions(auctionScriptAddress: string) {
    listAllAuctions(auctionScriptAddress).then((auctions) => {
...
function listBiddableAuctions(auctionScriptAddress: string) {
    // Get the list of keys this person owns
    getAllYourPublicKeys()

    // Get the list of all auctions
    listAllAuctions(auctionScriptAddress)
...
function listAllAuctions(auctionContractAddress: string) {
    return new Promise((resolve, reject) => {
